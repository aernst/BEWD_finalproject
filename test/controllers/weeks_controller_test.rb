...
class WeeksControllerTest < ActionController::TestCase
  ...
  test "should create week" do
    assert_difference('Week.count') do
      post :create, week: { date: @week.date, task: @week.task, user_id: @week.user_id, week_num: @week.week_num }
    end
  ...
  test "should update week" do
    patch :update, id: @week, week: { date: @week.date, task: @week.task, user_id: @week.user_id, week_num: @week.week_num }
    assert_redirected_to week_path(assigns(:week))
  end
