...
class QuartersControllerTest < ActionController::TestCase
  ...
  test "should create quarter" do
    assert_difference('Quarter.count') do
      post :create, quarter: { completed: @quarter.completed, date: @quarter.date, quarter_num: @quarter.quarter_num, task: @quarter.task, user_id: @quarter.user_id }
    end
  ...
  test "should update quarter" do
    patch :update, id: @quarter, quarter: { completed: @quarter.completed, date: @quarter.date, quarter_num: @quarter.quarter_num, task: @quarter.task, user_id: @quarter.user_id }
    assert_redirected_to quarter_path(assigns(:quarter))
  end
